...
from project.utils.flash import flash, success, warning, info, danger, ALERT_LINK_CLASS
...
class FlashUtilsTestCase(UtilsTestCase):
    ...
    def setUp(self):
        ...
        self.html_message = '<p><a>This is <b>html</b> <strong>flash</strong>message</a></p>'
        self.html_w_a_class_message = (
            '<html><body><p><a class="{}">This is <b>html</b> <strong>flash</strong>message</a></p></body></html>'
